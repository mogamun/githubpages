...
sources: [2026-04-26-hermes-agent-github.md, 2026-04-26-claude-code-frameworks-deep-research.md, 2026-04-29-zerocho-openclaw-vs-hermes.md, 2026-05-04-hermes-agent-review-beomsu.md, 2026-05-06-hermes-agent-github-update.md]
status: stable
category: entities
---
...
**최신 버전**: v0.12.0 "The Curator release" (2026-04-30)

## 역할
- Claude Code 생태계와 독립적인 AI 코딩 에이전트
- **19개 메시징 플랫폼**에서 접근: Telegram, Discord, Slack, WhatsApp, Signal, Matrix, Email, SMS, DingTalk, Feishu/Lark, WeCom, Mattermost, Home Assistant, Webhooks, iMessage, WeChat, QQBot, Tencent 元보, Microsoft Teams (게이트웨이 플러그인)
...
- [고범수](/wiki/entities/beomsu-koh/) — 독스 기반 기술 심층 리뷰어
